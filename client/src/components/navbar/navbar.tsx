...
const NavbarMenu: React.FC<Menu> = (props: Menu) => {
  ...
  return (
    <li>
      { props.href && <Link to={props.href}>{props.title}</Link>}
      { props.submenu && 
        <>
...
const Navbar: React.FC<any> = (props: NavbarProps) => {
  ...
  return (
    <div className="navbar bg-base-100 shadow-lg rounded-lg border-2">
      <div className="navbar-start">
        ...
        <a className="btn btn-ghost normal-case text-xl">{props.brand || "Brand"}</a>
